...
System.register("Url/Url", ["Di/Container"], function (exports_176, context_176) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            Url = class Url extends Container_2.Container {
                /**
                 *
                 * @param url
                 */
...
System.register("Starter/ResolvePaths", ["Di/Service"], function (exports_177, context_177) {
    "use strict";
    var __moduleName = context_177 && context_177.id;
    var Service_111, ResolvePaths;
    return {
        setters: [
        ...
        execute: function () {
            ResolvePaths = class ResolvePaths {
                ...
                constructor(paths) {
                    this.paths = paths;
                    this.di = new Service_111.Service;
                }
                /**
                 *
                 */
