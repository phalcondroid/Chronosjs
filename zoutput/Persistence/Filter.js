                    ...
                    for (var key in params) {
                        switch (key) {
                                    ...
                                    switch (keyConditional) {
                                        case DatamapperOperators.AND:
                                            ...
                                            for (let keyAnd in andContent) {
                                                this.getExpression(keyAnd, andContent[keyAnd], ComparisonOperators.AND, iAnd, andLength);
                                                iAnd++;
                                            }
                                            break;
                                        case DatamapperOperators.OR:
                                            ...
                                            for (let keyOr in orContent) {
                                                this.getExpression(keyOr, orContent[keyOr], ComparisonOperators.OR, iOr, orLength);
                                                iOr++;
                                            }
                                            break;
                                        case DatamapperOperators.IS_NOT:
                                            ...
                                            for (let keyIsNot in isNotContent) {
                                                this.getExpression(keyIsNot, isNotContent[keyIsNot], ComparisonOperators.AND, iIsNot, isNotLength, ComparisonOperators.DIFFERENT);
                                                iIsNot++;
                                            }
                                            break;
                                        default:
                            ...
                            case DatamapperOperators.COLUMNS:
                                ...
                                break;
                            default:
                                this.getExpression(key, params[key], ComparisonOperators.AND, index, length);
                                index++;
                                break;
                        }
                    }
